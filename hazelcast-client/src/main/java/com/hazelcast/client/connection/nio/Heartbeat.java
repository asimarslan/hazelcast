...
public class Heartbeat implements Runnable {
    ...
    Heartbeat(ClientConnectionManagerImpl clientConnectionManager, HazelcastClientInstanceImpl client) {
        ...
        this.logger = client.getLoggingService().getLogger(Heartbeat.class);
